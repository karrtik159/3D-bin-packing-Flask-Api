        ...
        if not rotation_type_list:
            ...
            for rotation in rotation_type_list:
                ...
                if self.fix_point == True:
                    ...
                    if self.check_stable == True:
                        item_area_lower = int(
                            (dimension[0] - self.gap) * (dimension[1] - self.gap)
                        )
                        support_area_upper = 0
                        for i in self.fit_items:
                            if z == i[5]:
        ...
        for axis in range(0, 3):
            ...
            for ib in items_in_bin:
                ...
                if axis == Axis.WIDTH:  # axis = 0/ x-axis
                    pivot = [
                        ib.position[0] + ib.getDimension()[0],
                        ib.position[1],
                        ib.position[2],
                    ]
                        ...
                        while q < len(items_in_bin_temp):
                            if items_in_bin_temp[q] == items_in_bin[n]:
                                ...
                                if (
                                    ...
                                    + ib_neighbor.getDimension()[1]
                                    > ib.position[1]
                                    and ib_neighbor.position[2]
                                    + ib_neighbor.getDimension()[2]
                                    > ib.position[2]
                                ):
                                    right_neighbor = True
